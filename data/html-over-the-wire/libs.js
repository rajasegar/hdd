...
It has no dependencies and plays nice with existing code.`,
  ...
  },
  {
    ...
    name: 'Blazor Server',
    description: `
    With the Blazor Server hosting model, the app is executed on the server from within an ASP.NET Core app. UI updates, event handling, and JavaScript calls are handled over a SignalR (graceful fallback framework from websockets -> SSE -> Polling)  connection.`,
    website: 'https://docs.microsoft.com/en-us/aspnet/core/blazor/hosting-models?view=aspnetcore-6.0#blazor-server',
    github: {
      stars: 27720,
      forks: 7655,
      issues: 2700,
      url: 'https://github.com/dotnet/aspnetcore/tree/main/src/Components',
    },
    language: 'C#',
    ajax: true,
    history: true,
    ...
    features: [],
    releasedIn: 'Sept 2019',
    summary: `Blazor Server enables you to do something similar to Phoenix framework LiveView using ASP.NET Core.`,
  },
];
